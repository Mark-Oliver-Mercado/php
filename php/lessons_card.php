...
if (isset($_GET['age'])) {
    ...
    header('Location: card_select.php'); // Redirect if age is missing
    exit();
}
?>
<?php
...
<body>
    ...
    <section>
        <div class="display1">
            <div class="display" onclick="window.location.href='card.php?age=<?php echo $_SESSION['age']; ?>&lesson=1'">
                <h1>Lesson 1</h1>
            </div>
            <div class="display" onclick="window.location.href='card.php?age=<?php echo $_SESSION['age']; ?>&lesson=2'">
                <h1>Lesson 2</h1>
            </div>
            <div class="display" onclick="window.location.href='card.php?age=<?php echo $_SESSION['age']; ?>&lesson=3'">
                <h1>Lesson 3</h1>
            </div>
